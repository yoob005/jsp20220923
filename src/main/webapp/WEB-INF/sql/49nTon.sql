...
-- 강의 
CREATE TABLE Lecture(id INT PRIMARY KEY AUTO_INCREMENT, name VARCHAR(255) NOT NULL);
...
CREATE TABLE StudentLecture(studentId INT NOT NULL, lectureId INT NOT NULL,
